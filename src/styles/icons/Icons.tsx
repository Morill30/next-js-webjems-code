...
export default function Icons(prop: any) {
  return (
...
function IconsPrep({ type, className }: { type: string; className?: string }) {
  switch (type) {
    case "Education":
      return (
        <svg
    ...
    case "message":
      return (
        ...
        >
          <path
            d="M6,18.28a8.19,8.19,0,0,1-4-6.94C2.08,6.64,6.62,2.91,12.14,3S22.07,7,22,11.66,17.38,20.09,11.86,20A11.63,11.63,0,0,1,10,19.82L5.5,22Z"
            fill="none"
          />
          <rect x="11.5" y="11" width="1" height="1" rx="0.5" fill="none" />
          <rect x="15.5" y="11" width="1" height="1" rx="0.5" fill="none" />
          <rect x="7.5" y="11" width="1" height="1" rx="0.5" fill="none" />
        </svg>
      );
    case "globe":
      return (
        ...
        >
          <polyline
            points="3.5 6.5 6.5 9.5 6.5 12.5 8.5 14.5 12 14.5 14 16.5 14 19 11 22"
            fill="none"
          />
          <polyline
            points="17 3.5 13.5 7 13.5 10.5 15.5 12 18.5 12 20 13.5 20 18"
            fill="none"
          />
